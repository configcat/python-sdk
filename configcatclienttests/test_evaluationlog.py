...
class EvaluationLogTests(unittest.TestCase):
    ...
    def test_options_based_on_custom_attr(self):
        ...
        client.get_value('string75Cat0Dog25Falcon0HorseCustomAttr', False, User('12345'))
        self.assertEqual(
            self.log_handler.info_logs[0],
        ...
        client.get_value('string75Cat0Dog25Falcon0HorseCustomAttr', False, User('12345', country='US'))
        self.assertEqual(
            self.log_handler.info_logs[0],
